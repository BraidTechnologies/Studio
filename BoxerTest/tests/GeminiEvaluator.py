...
class GeminiEvaluator:
    def __init__(self):
        ...
        This class provides functions for evaluating the quality of summaries generated by a large language model (LLM). The primary task is to evaluate how effectively the summary captures the core information from the original content and addresses the user's query.
        """
