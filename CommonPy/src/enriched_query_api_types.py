...
- IGenerateQuestionRequest: Request structure for question generation
- IQuestionGenerationResponse: Response structure for question generation
- IGenerateIdealAnswerRequest: Request structure for ideal answer generation
- IGenerateIdealAnswerResponse: Response structure for ideal answer generation
'''
...
class IGenerateIdealAnswerRequest():
    question: str
    wordTarget: float

class IGenerateIdealAnswerResponse():
    answer: str
