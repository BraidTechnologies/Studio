...
// Internal imports
const IModelDriver_1 = require("./Interfaces/IModelDriver");
const PromptPersonaFactory_1 = require("promptmanager/dist/src/PromptPersonaFactory");
...
function chat(persona, urlElement, prompt, params, useAzure) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const summariser = (0, PromptPersonaFactory_1.getChatPersona)(persona, prompt.prompt, params);
