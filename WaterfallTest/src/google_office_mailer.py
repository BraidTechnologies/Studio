...
def send_mail(output_location: str, body: str, attachment: str, spec: PipelineSpec):
...
def send_message_with_attachment(service, output_location: str, body: str, attachment: str, spec: PipelineSpec):
