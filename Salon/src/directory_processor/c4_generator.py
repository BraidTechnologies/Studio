...
def remove_mermaid_fences(text: str) -> str:
    """
    Removes any ```mermaid or ``` fences (case-insensitive) from the text,
    leaving only the raw diagram code.
    """
    # Remove ```mermaid lines
...
class C4Generator(DirectoryProcessor):
    ...
    def visit(self, directory_data: DirectoryData) -> None:
        ...
        if summary:
            # Remove  fence, and append footer
            summary = remove_mermaid_fences(summary)
